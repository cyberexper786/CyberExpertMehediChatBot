...
module.exports.run = async function ({ api, event }) {
  ...
  const path = __dirname + "/cache/sex11.jpg";
  ...
  try {
    ...
    api.sendMessage("❌ Image load করতে সমস্যা হচ্ছে, একটু পর আবার চেষ্টা করো।", event.threadID, event.messageID);
  }
};
