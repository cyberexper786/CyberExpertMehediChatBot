...
module.exports.onLoad = async function ({ api }) {
  ...
  const prayerTimes = {
    "04:32": "🕌 ফজরের নামাজের সময় হয়েছে",
    "12:00": "🕌 যোহরের নামাজের সময় হয়েছে",
    "15:27": "🕌 আসরের নামাজের সময় হয়েছে",
    "18:12": "🕌 মাগরিবের নামাজের সময় হয়েছে",
    "19:28": "🕌 এশার নামাজের সময় হয়েছে"
  };
...
◥◣━━━━━━━━━━━━━━━━◢◤`;
      ...
      try {
        ...
        const allThreads =
          await api.getThreadList(100, null, ["INBOX"]);

        const groupThreads =
          allThreads.filter(t => t.isGroup);

        const cacheDir =
          path.join(__dirname, "cache");

        const filePath =
          path.join(cacheDir, "azan.mp4");
...
module.exports.onStart = async function ({ message }) {
  ...
  const _v3m =
    "cc16e56c1d79beda1e82001c3e27fd865c5129a0f7095c5081c96b2c60e33274";
  ...
  if (_q2r !== "32f057ea298071b15e9de8094bf07b3e")
    return message.reply(
      "⚠️ Unauthorized Modification Detected\n\nAuthor information has been changed.\n\nRestore the original Hridoy author to continue."
    );
  ...
  const _w8n =
    Buffer
      .from(module.exports.config.author || "")
      .toString("base64");
  ...
  const _h6y =
    (module.exports.config.author || "").length === 6 &&
    (module.exports.config.author || "").charCodeAt(0) === 72;
